          ...
          .row.justify-content-around.align-items-center
            ...
            .col-lg-10
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  p Si se habla de segmentación de mercado, se debe entender desde lo general a lo específico, siendo así, de ese mundo completo del mercado, a mundos cada vez más particulares, dirigidos a una población meta con ciertos criterios y estándares, cultura y gustos muy detallados; precisamente esta es la clave de la segmentación de mercados.

    .row.align-items-center.justify-content-center
      .col-lg-4(data-aos="fade-right")  
        img.mb-3(src='@/assets/curso/images/tema1/img_2.png')
      .col-lg-6(data-aos="fade-left")
        p.mb-3 La definición de los criterios que cada empresa busca y define para cumplir con los requisitos de su población meta, es la clave del éxito, puesto que no todas las estrategias son efectivas, teniendo en cuenta que en el factor humano no todas las personas piensan igual y tienen gustos diferentes, por lo que hacen de este proceso vital para generar estos grupos particulares, un gran desafío.

        p.mb-3 Como Ferrell y Hartline (2018) mencionan, “la segmentación debe crear grupos en donde los integrantes tengan gustos, experiencias o preferencias similares; pero en donde los grupos en sí mismos no sean similares entre sí” (p. 129).

        p.mb-0 Esta es la clave del éxito uniendo grupos de personas con características similares en gustos y pensamientos diferentes, logrando crear necesidades en ellos, a través de una correcta estrategia que los identifique, para ello es necesario comprender los alcances, sus variables y sus criterios, además del constante monitoreo del mercado para estar a la vanguardia y ser flexibles a lo que la economía demande.
      ...
      .col-lg-6(data-aos="fade-right") 
        p.mb-3 Para monitorear mercados, se requiere de un plan que debe constantemente realizar la empresa para permanecer a la vanguardia, sin dejar que su competencia le aventaje por mucho, por lo que debe:
          ul.lista-ul--color.mt-3
            ...
            li.mb-4
              i.fas.fa-paper-plane.colr_2
              | Identificar las culturas cambiantes de las personas permeadas por la globalización, entre otros elementos.
      
  .container.bg-white.px-md-5.px-3.py-2.container-top.fondo.mb-0.cs

    p.mb-3 En otras palabras, el trabajo de monitorear los mercados básicamente es el mismo trabajo que se realizó para segmentar el mercado, pero de una manera más cercana, dado que ya se tiene el mercado meta y sobre él, se deben aplicar los criterios de segmentación y sus estudios pertinentes.
      ...
      .col-lg-6(data-aos="fade-left")
          p.mb-3 Si la empresa es competente, puede competir dentro de los rangos de precios que la economía ha dispuesto, porque:
            ul.lista-ul--color
              ...
              li.mb-4
                i.fas.fa-paper-plane.colr_2
                | Está constantemente a la vanguardia con los avances que se presentan en el sector. 
              li.mb-4
                i.fas.fa-paper-plane.colr_2
                | Analiza los patrones de consumo de su público objetivo, es decir identifica sí ha cambiado o se mantiene igual.
    ...
    p.mb-5 Teniendo claro cómo deben ser los datos, se hace necesario seguir algunos principios para ser el soporte a la supervisión, la toma de decisiones y actualización que las empresas necesitan en cuanto a su sector, estos son:
